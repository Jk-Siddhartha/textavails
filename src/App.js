...
function App() {
  ...
  function copyText() {
    ...
    let copiedtext =
      copiedtextContainer.textContent ||
      copiedtextContainer.innerText ||
      copiedtextContainer.innerHTML;
    ...
    <>
      <div className="App">
        ...
        <div className="container">
          <h1>
            TextAvails :- Text Transform, Word Count, Alphabet Count, Remove
            extra spaces, etc.
          </h1>
          <textarea
            name="input"
        ...
        <div className="btns">
          ...
          <button className="btn" onClick={CountWord}>
            word count
          </button>
          <button className="btn" onClick={CountAlphabet}>
            alphabet count
          </button>
        </div>
